...
from django.views.generic import TemplateView # For a simple home view initially
...
urlpatterns = [
    ...
    path('tasks/', include('tasks.urls')), # Will be added later for task specific URLs
]